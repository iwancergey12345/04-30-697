...
export default function Header() {
  ...
  return (
    <div className=" flex items-stretch justify-between ">
      <div className="bg-sky-400 flex items-center justify-center w-28 h-28">
        <img src={logo} height="80px" width="auto" alt="logo" />
      </div>
      <div className="grow hidden lg:flex items-center justify-center gap-16 rounded-md bg-indigo-400  font-bold p-5">
      ...
      <div className='flex items-center justify-around  w-80 px-10 bg-orange-300 text-white font-bold'>
        <DropdownMenu
        className='font-bold'
